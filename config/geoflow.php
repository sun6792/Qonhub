...
return [
    ...
    // 站点展示名称（页眉、标题等）
    'site_name' => env('SITE_NAME', 'Qonhub AI'),
    // 站点完整/副标题文案
    'site_full_name' => env('SITE_FULL_NAME', 'Qonhub AI'),
    ...
    // Embedding 文档向量化单次请求切片数；OpenAI 支持 2048，保守取 300。
    'embedding_batch_size' => max(1, min(300, (int) env('GEOFLOW_EMBEDDING_BATCH_SIZE', 300))),
