...
<body class="ne-body">
    @include('theme.geoflow-template-15-reading-medium.partials.header')
    <main class="ne-main">
        @yield('content')
    </main>
    @include('theme.geoflow-template-15-reading-medium.partials.footer')
    @stack('scripts')
    <script src="{{ asset('assets/js/main.js') }}"></script>
    <script src="{{ asset('themes/geoflow-template-15-reading-medium/theme.js') }}" defer></script>
</body>
</html>
