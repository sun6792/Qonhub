...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/apihot-recommend-20260623/theme.css') }}">
...
<body class="ne-body">
    @include('theme.apihot-recommend-20260623.partials.header')
    <main class="ne-main">
        @yield('content')
    </main>
    @include('theme.apihot-recommend-20260623.partials.footer')
    @stack('scripts')
    <script src="{{ asset('assets/js/main.js') }}"></script>
    <script src="{{ asset('themes/apihot-recommend-20260623/theme.js') }}" defer></script>
</body>
</html>
