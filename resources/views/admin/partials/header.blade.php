@php
    ...
    $menu = [
        ...
        'ai_models'   => ['route' => 'admin.ai-models.index',     'name' => '🔑 AI模型'],
    ];
    if ($isSuperAdmin) {
    ...
    $subMap = [
        ...
        'admin.operator-monitor.index' => 'workspaces', 'admin.operator-monitor.detail' => 'workspaces',
        'admin.ai-visibility.index' => 'workspaces', 'admin.ai-visibility.show' => 'workspaces',
        'admin.enterprise-anchor.overview' => 'workspaces', 'admin.enterprise-anchor.manage' => 'workspaces',
        'admin.platform-accounts.index' => 'workspaces', 'admin.platform-accounts.show' => 'workspaces',
        // 分发（新旧系统统一）
        'admin.content-publish.index' => 'content_publish', 'admin.content-publish.store' => 'content_publish',
        'admin.content-publish.task' => 'content_publish', 'admin.content-publish.retry' => 'content_publish',
        'admin.content-publish.cancel' => 'content_publish', 'admin.content-publish.progress' => 'content_publish',
        'admin.distribution.index' => 'content_publish', 'admin.distribution.create' => 'content_publish',
        'admin.distribution.show' => 'content_publish', 'admin.distribution.jobs' => 'content_publish',
        // 文章
