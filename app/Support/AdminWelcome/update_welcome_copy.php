...
return static function (array $welcomeState): array {
    ...
    return [
        'zh-CN' => [
            ...
            'letter' => [
                ...
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleZh !== '' ? $titleZh : '后台已经检测到豆流 AI 有一个新版本可用。',
                    ],
                    [
                        'type' => 'paragraph',
        ...
        'en' => [
            ...
            'letter' => [
                'title' => 'A new Douluo AI version is available',
                'subtitle' => 'Current version v'.$currentVersion.', latest version v'.$latestVersion.'.',
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleEn !== '' ? $titleEn : 'The admin has detected that a newer Douluo AI release is available.',
                    ],
                    [
                        'type' => 'paragraph',
