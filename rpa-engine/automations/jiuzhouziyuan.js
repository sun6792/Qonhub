/**
 * 九州资源网 (jiuzhouziyuan.com) 企业注册认证脚本。
 *
 * 九州资源网是免费B2B企业资源推广平台。
...
export const description = "九州资源网 — 免费B2B企业资源推广注册";

class JiuzhouScript extends BasePlatformScript {
    registerUrl = "https://www.jiuzhouziyuan.com/register/";
    certifyUrl = "https://www.jiuzhouziyuan.com/member/";
    ...
    async registerFlow(page) {
        ...
        await page.goto("https://www.jiuzhouziyuan.com/", { waitUntil: "domcontentloaded", timeout: 15000 });
        ...
        if (!body1.includes("注册") || body1.length < 200) {
            const regCandidates = [
                "https://www.jiuzhouziyuan.com/user/register/",
                "https://www.jiuzhouziyuan.com/member/register/",
                "https://www.jiuzhouziyuan.com/register/",
                "https://member.jiuzhouziyuan.com/register/",
            ];
        ...
        const memberUrls = [
            "https://www.jiuzhouziyuan.com/member/",
            "https://www.jiuzhouziyuan.com/user/",
            "https://www.jiuzhouziyuan.com/member/index.php",
            "https://www.jiuzhouziyuan.com/my/",
        ];
        let loggedIn = false;
        ...
        if (!loggedIn) {
            ...
            const loginUrls = [
                "https://www.jiuzhouziyuan.com/user/login/",
                "https://www.jiuzhouziyuan.com/member/login/",
                "https://www.jiuzhouziyuan.com/login/",
            ];
        ...
        const editCandidates = [
            "https://www.jiuzhouziyuan.com/member/company/",
            "https://www.jiuzhouziyuan.com/member/edit/",
            "https://www.jiuzhouziyuan.com/member/info/",
            "https://www.jiuzhouziyuan.com/member/company/edit/",
            "https://www.jiuzhouziyuan.com/user/info/",
        ];
        let editFound = false;
        ...
        if (!editFound) {
            try {
                await page.goto("https://www.jiuzhouziyuan.com/member/", { waitUntil: "domcontentloaded", timeout: 10000 });
                await this.wait(2000, 3000);
            } catch {}
        ...
        for (const link of allLinks) {
            try {
                ...
                if (href && (
                    ...
                    const candidate = href.startsWith("http") ? href : `https://www.jiuzhouziyuan.com${href.startsWith("/") ? "" : "/"}${href}`;
        ...
        if (!shopUrl) {
            ...
            const possibleUrls = [
                `https://${companySlug}.jiuzhouziyuan.com/`,
                `https://www.jiuzhouziyuan.com/shop/${companySlug}/`,
                `https://www.jiuzhouziyuan.com/company/${companySlug}/`,
            ];
            ...
            if (!shopUrl) {
                shopUrl = `https://www.jiuzhouziyuan.com/company/${companySlug}/`;
            }
        ...
        return {
            ...
            account_id: username,
            status: "certified",
            message: "九州资源网企业认证已提交",
        };
    }
}

export async function execute(o) {
    const script = new JiuzhouScript(o.taskId, o.account, o.enterprise, o.options, o.logger.info.bind(o.logger));
