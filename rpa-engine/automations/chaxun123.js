/**
 * 查询123 (chaxun123.com) 企业注册认证脚本。
 *
 * 查询123是B2B企业信息查询与黄页平台。
...
export const platform = "chaxun123";
export const description = "查询123 — B2B企业信息查询与黄页注册";

class Chaxun123Script extends BasePlatformScript {
    registerUrl = "https://www.chaxun123.com/register/";
    certifyUrl = "https://www.chaxun123.com/member/";
    ...
    async registerFlow(page) {
        ...
        await page.goto("https://www.chaxun123.com/", { waitUntil: "domcontentloaded", timeout: 15000 });
        ...
        const regEntry = await this.findElement(page, [
            ...
            'a:has-text("免费加入")', '.reg-btn', '.register-btn',
        ]);
        if (regEntry) {
        ...
        if (!body1.includes("注册") || body1.length < 200) {
            const regCandidates = [
                "https://www.chaxun123.com/user/register/",
                "https://www.chaxun123.com/member/register/",
                "https://www.chaxun123.com/register/",
                "https://member.chaxun123.com/register/",
            ];
        ...
        const memberUrls = [
            "https://www.chaxun123.com/member/",
            "https://www.chaxun123.com/user/",
            "https://www.chaxun123.com/member/index.php",
            "https://www.chaxun123.com/my/",
        ];
        let loggedIn = false;
        ...
        if (!loggedIn) {
            ...
            const loginUrls = [
                "https://www.chaxun123.com/user/login/",
                "https://www.chaxun123.com/member/login/",
                "https://www.chaxun123.com/login/",
            ];
        ...
        const editCandidates = [
            "https://www.chaxun123.com/member/company/",
            "https://www.chaxun123.com/member/edit/",
            "https://www.chaxun123.com/member/info/",
            "https://www.chaxun123.com/member/company/edit/",
            "https://www.chaxun123.com/user/info/",
        ];
        let editFound = false;
        ...
        if (!editFound) {
            try {
                await page.goto("https://www.chaxun123.com/member/", { waitUntil: "domcontentloaded", timeout: 10000 });
                await this.wait(2000, 3000);
            } catch {}
        ...
        for (const link of allLinks) {
            try {
                ...
                if (href && (
                    ...
                    const candidate = href.startsWith("http") ? href : `https://www.chaxun123.com${href.startsWith("/") ? "" : "/"}${href}`;
        ...
        if (!shopUrl) {
            ...
            const possibleUrls = [
                `https://${companySlug}.chaxun123.com/`,
                `https://www.chaxun123.com/shop/${companySlug}/`,
                `https://www.chaxun123.com/company/${companySlug}/`,
            ];
            ...
            if (!shopUrl) {
                shopUrl = `https://www.chaxun123.com/company/${companySlug}/`;
            }
        ...
        return {
            ...
            account_id: username,
            status: "certified",
            message: "查询123企业认证已提交",
        };
    }
}

export async function execute(o) {
    const script = new Chaxun123Script(o.taskId, o.account, o.enterprise, o.options, o.logger.info.bind(o.logger));
