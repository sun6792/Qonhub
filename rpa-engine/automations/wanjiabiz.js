...
export const platform = "wanjiabiz";
export const description = "万家商务网 — 综合性B2B企业黄页注册";

class WanjiabizScript extends BasePlatformScript {
    registerUrl = "https://www.wanjiabiz.com/register/";
    certifyUrl = "https://www.wanjiabiz.com/member/";
    ...
    async registerFlow(page) {
        ...
        await page.goto("https://www.wanjiabiz.com/", { waitUntil: "domcontentloaded", timeout: 15000 });
        ...
        if (!body1.includes("注册") || body1.length < 200) {
            const regCandidates = [
                "https://www.wanjiabiz.com/user/register/",
                "https://www.wanjiabiz.com/member/register/",
                "https://www.wanjiabiz.com/register/",
                "https://member.wanjiabiz.com/register/",
            ];
        ...
        const memberUrls = [
            "https://www.wanjiabiz.com/member/",
            "https://www.wanjiabiz.com/user/",
            "https://www.wanjiabiz.com/member/index.php",
            "https://www.wanjiabiz.com/my/",
        ];
        let loggedIn = false;
        ...
        if (!loggedIn) {
            ...
            const loginUrls = [
                "https://www.wanjiabiz.com/user/login/",
                "https://www.wanjiabiz.com/member/login/",
                "https://www.wanjiabiz.com/login/",
            ];
        ...
        const editCandidates = [
            "https://www.wanjiabiz.com/member/company/",
            "https://www.wanjiabiz.com/member/edit/",
            "https://www.wanjiabiz.com/member/info/",
            "https://www.wanjiabiz.com/member/company/edit/",
            "https://www.wanjiabiz.com/user/info/",
        ];
        let editFound = false;
        ...
        if (!editFound) {
            try {
                await page.goto("https://www.wanjiabiz.com/member/", { waitUntil: "domcontentloaded", timeout: 10000 });
                await this.wait(2000, 3000);
            } catch {}
        ...
        for (const link of allLinks) {
            try {
                ...
                if (href && (
                    ...
                    const candidate = href.startsWith("http") ? href : `https://www.wanjiabiz.com${href.startsWith("/") ? "" : "/"}${href}`;
        ...
        if (!shopUrl) {
            ...
            const possibleUrls = [
                `https://${companySlug}.wanjiabiz.com/`,
                `https://www.wanjiabiz.com/shop/${companySlug}/`,
                `https://www.wanjiabiz.com/company/${companySlug}/`,
            ];
            ...
            if (!shopUrl) {
                shopUrl = `https://www.wanjiabiz.com/company/${companySlug}/`;
            }
        ...
        return {
            ...
            account_id: username,
            status: "certified",
            message: "万家商务网企业认证已提交",
        };
    }
}

export async function execute(o) {
    const script = new WanjiabizScript(o.taskId, o.account, o.enterprise, o.options, o.logger.info.bind(o.logger));
